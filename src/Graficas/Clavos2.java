 ...
 * @author Ramon
 */
public class Clavos2 extends javax.swing.JFrame {
...
cargarCiudadbox();
    ...
    private void initComponents() {
        ...
        jPanel2.add(valor, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 250, 80, -1));
        ...
        jPanel2.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 540, 370));
        ...
        jPanel2.add(cuotas, new org.netbeans.lib.awtextra.AbsoluteConstraints(118, 203, 80, -1));
...
this.cargarDeudos(2, ciudadbox, cpaz);        // TODO add your handling code here:
...
if (txt_nombre.getText().isEmpty()) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
           ...
           if (prestamo.getText().equals("") || intereses.getText().equals("") || valor.getText().equals("") || valor.getText().equals("")) {
...
actualizarTabla(1,ciudadbox, cpaz);
    ...
    private void interesesKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_interesesKeyPressed
         c1.desplazarClientesConEnter(ciudadbox, intereses, valor);
    // TODO add your handling code here:
    ...
    private void valorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_valorKeyPressed
          c1.desplazarClientesConEnter(ciudadbox, valor, valor);
    // TODO add your handling code here:
  ...
  private void refinanciar() {
        ...
        try {
           ...
           consulta.setInt(4, Integer.parseInt(valor.getText()));
            consulta.setInt(5, Integer.parseInt(valor.getText()));
              ...
              LocalDate fechaActual = LocalDate.now();
                    LocalDate fechaVencimiento = fechaActual.plusDays(Integer.parseInt(valor.getText().trim()));
